...
function AboutProject () {
  return(
    <Section sectionName='about-project' link="about-project" sectionNameTitle='about-project__title' content='О проекте'>
    <ul className='project about-project__info-list'>
    ...
    <ul className='project about-project__timing'>
      <li>
        <p className='project__timing-period project__timing-period_black'>1 неделя</p>
        <p className='project__timing-name'>Back-end</p>
      </li>
      <li>
